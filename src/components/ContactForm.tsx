...
const ContactForm = ({theme}) => {
    ...
    return (
        ...
        <div className="flex-col gap-3 mt-7">
            ...
            <textarea name="" id="" className=" w-[600px] h-[300px] px-8 py-3 border border-neutral-300 text-xl rounded-md xs:w-[100%] xs:py-1" placeholder="Enter your message" value={message} onChange={(event) => { setMessage(event.target.value) }}></textarea>
        </div>
    ...
    <div className=" flex-col gap-5  border-green-500 w-fit mx-auto my-24 px-9 py-9 rounded-md shadow-lg shadow-black xs:w-[90%] bg-neutral-700">
            ...
            <div className="flex-col gap-3 mt-7">
                ...
                <textarea name="" id="" className=" w-[600px] h-[300px] px-8 py-3 border border-neutral-300 rounded-md xs:w-[100%] xs:py-1 text-black text-xl" placeholder="Enter your message" value={message} onChange={(event) => { setMessage(event.target.value) }}></textarea>
            </div>

            

            {
                submitStatus ?<div className="w-fit h-fit" onClick={submitHandler}>
                <Buttons text="bg-[#7843E9] rounded-md  w-fit border border-[#7843E9] px-10 text-lg text-white mt-3 py-2 font-pop mb-2 duration-150 hover:scale-[99%] xs:px-3 xs:py-1" content="SUBMITTING"></Buttons>
            </div> :  <div className="w-fit h-fit" >
                <Buttons text="bg-[#7843E9] rounded-md  w-fit border border-[#7843E9] px-10 text-lg text-white mt-3 py-2 font-pop mb-2 duration-150 hover:scale-[99%] xs:px-3 xs:py-1" content="SUBMIT"></Buttons>
            </div> 
            }
